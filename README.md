...
## Структура проекта
    ...
    .
    ├── app     // Каталог исходного кода
    ├   ├── scss
    ├   ├   ├── main.scss
    ├   ├── js // Каталог исходного кода JavaScript
    ├   ├   ├── main.js
    ├   ├── jade // Каталог шаблонов Jade
    ├   ├   ├── _layout.jade
    ├── dev      // Каталог разработки и тестирования
